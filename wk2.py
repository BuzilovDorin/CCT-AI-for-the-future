...
shopping_list = ["banana", "apple", "orange", "kiwi", "strawberries"] # Fill in with some values

print(shopping_list) # Print the whole list

print(shopping_list[1]) # Figure out how to print individual values
...
print(nutrition_facts["item"]) # Uncomment this line and pick a value to print individually
